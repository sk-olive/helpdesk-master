 ...
 <?php
    ...
    if (isset($_POST['addPMSAction'])) {
        ...
        $user = $_POST['deviceUser'];
        $email = $_POST['deviceEmail'];
        $sql = "INSERT INTO `pmsaction`(`deviceName`, `action`, `performedBy`, `Date`, `month`, `year`) VALUES ('$deviceId','$actionPms','$name','$date','$month','$selectedYear')";
        ...
        if ($results) {
            ...
            try {
                ...
                echo "<script>alert('PMS Completed.') </script>";
                echo "<script> location.href='pms.php'; </script>";
                                ...
                                ?>
                                 <tr class="">
                                     ...
                                     <td>
                                         ...
                                         <button type="button" id="viewdetails" onclick="modalShow(this)" data-deviceid="<?php echo $row['computerName']; ?>" data-email="<?php echo $row['email']; ?>" data-user="<?php echo $row['user']; ?>" <?php if ($row['action'] != "") {
                                                                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                                                                } ?> class="inline-block px-6 py-2.5 <?php if ($row['action'] != "") {
                                                                                                                                                                                                                                                                                            echo "text-white bg-blue-400 dark:bg-blue-500 cursor-not-allowed";
                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                            echo "bg-blue-600 text-white";
                                                                                                                                                                                                                                                                                        } ?> font-medium text-xs leading-tight uppercase rounded shadow-md <?php if ($row['action'] != "") {
                                                                                                                                                                                                                                                                                                                                                                                                        echo "";
                                                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                                                        echo "hover:bg-blue-700 hover:shadow-lg";
             ...
             <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                 <form action="" method="POST" onsubmit="$('#loading-message').css('display', 'flex'); $('#loading-message').show();">
                     ...
                     <div id="buttonAdd" class=" items-center p-4 border-t border-gray-200 rounded-b dark:border-gray-600">
                         <button type="submit" name="addPMSAction" class="shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80  w-full text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Add</button>
                     </div>
