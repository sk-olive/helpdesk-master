...
<section class="mt-10">
  <table id="adminApprovalTable" class="display" style="width:100%">
    ...
    <tbody>
      ...
      $sql = "select * from `request` WHERE `department` = '$user_dept' and `status2` = 'admin' order by id asc  ";
