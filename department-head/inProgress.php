...
<section class="mt-10">
  <table id="inProgressTable" class="display" style="width:100%">
    ...
    <tbody>
      ...
      $sql = "select * from `request` WHERE `department` = '$user_dept' and `status2` = 'inprogress' order by id asc  ";
