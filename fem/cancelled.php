      ...
      ?>
        <tr class="">
          ...
          <td>
            ...
            <button type="button" id="viewdetails" onclick="modalShow(this)" data-requestor="<?php echo $row['requestor'] ?>" data-cancelledby="<?php echo $row['cancelledBy'] ?>" data-reason="<?php echo $row['reasonOfCancellation'] ?>" data-joidprint="<?php $date = new DateTime($row['date_filled']);
                                                                                                                                                                                                                                                          $date = $date->format('ym');
