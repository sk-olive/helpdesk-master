...
<table id="pmsTable" class="display" style="width:100%">
        ...
        <?php
             ...
             <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
              ...
              <td>
              <a type="button" href="<?php echo $row['location']; ?>" id="viewdetails" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"> 
                    Download
                    </a>
              </td>
